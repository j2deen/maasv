...
logger = logging.getLogger("maev.lifecycle.inference")
...
def _store_inferences(inferences: list[dict]) -> int:
    ...
    from maev.core.graph import find_entity_by_name, find_or_create_entity, add_relationship, _clamp_confidence
