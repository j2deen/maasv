...
logger = logging.getLogger("maev.extraction.entity_extraction")
...
class EntityExtractor:
    ...
    def __init__(self, model: str = None):
        import maev
        self.model = model or maev.get_config().extraction_model
    ...
    def store_extracted_entities(self, extraction_result: dict) -> dict:
        ...
        from maev.core.graph import _clamp_confidence, MAX_ENTITY_NAME_LENGTH, VALID_PREDICATES
