...
def get_entity(entity_id: str):
    ...
    from maev.core.graph import get_entity_profile
    ...
    # maev returns entity_name/value internally; we expose object_name/object_value
...
def add_relationship(req: AddRelationshipRequest):
    ...
    from maev.core.graph import add_relationship
