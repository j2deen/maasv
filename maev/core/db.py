...
def _get_db_path():
    ...
    import maev
    return maev.get_config().db_path


def _get_embed_dims():
    """Get the configured embedding dimensions."""
    import maev
    return maev.get_config().embed_dims
...
def init_db():
    ...
    def _migrate_entity_trigram(db: sqlite3.Connection):
        ...
        # on entity names (e.g., "Robot" finds "MaevTestRobot").
