...
Reuses the MAEV_ env prefix and adds MCP-specific transport settings.
"""
...
class MCPSettings(BaseSettings):
    """MCP server configuration. All values from MAEV_ env vars or .env file."""
    ...
    model_config = {"env_prefix": "MAEV_", "env_file": ".env", "env_file_encoding": "utf-8"}
